...
*/
	std::string get_fees()
	{
		...
		/////////////////////////////////////////////////////////////////
		overdraft = customer->get_penalty();
		charge = customer->get_ccharge();
		/////////////////////////////////////////////////////////////////
...
protected:
	...
	*/
	void add_interest(double interest) {
		...
		////////////////////////////////////////////////////////////////////////
		tran = new Transaction(customer->get_id(), " Custom Interest ", amt, fees);
		////////////////////////////////////////////////////////////////////////
...
public:
	...
	*/
	...
	/**
	Generic accessor and setter methods for properties customer, balance, and account_number
	*/
	...
	*/
	...
	//////////////////////////////////////////////////////////////////////
		...
		ss << "  Telephone Number: " << customer->get_tele();
		ss << "  Address: " << customer->get_address();
	/////////////////////////////////////////////////////////////////////
...
public:
	...
	CheckingAcct(Customer *cust, int id) : Account(cust, id) {}
	...
	void add_interest() 
	{
		double amt = balance* customer->get_cinterest();
		balance = balance + amt;
		std::string fees = get_fees();
		Transaction *tran = NULL;

		tran = new Transaction(customer->get_id(), " Checking Interest ", amt, fees);
...
public:
	...
	SavingsAcct(Customer *cust, int id) : Account(cust, id) {}
	...
	void add_interest() 
	{
		double amt = balance*customer->get_sinterest();
		balance = balance + amt;
		std::string fees = get_fees();
		Transaction *tran = NULL;

		tran = new Transaction(customer->get_id(), " Savings Interest", amt, fees);
